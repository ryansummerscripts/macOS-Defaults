...
# Created by Ryan Summer     For macOS 12-26     Version 1.5
#
# Updated 03/22/2026
...
EOF
    echo -n "${NC}"
    echo_centered "${BL}Created by Ryan Summer${NC}  |  ${BL}For macOS 12-26${NC}  |  ${BL}Version 1.5${NC}"
}
            ...
            while true; do
                ...
                while true; do
                    ...
                    while true; do
                        ...
                        if [[ "$MACOS_MAJOR" -lt 26 ]]; then
                            echo "🚫 Disable compact tab layout ${MA}(Sequoia 15 and below)${NC}"
